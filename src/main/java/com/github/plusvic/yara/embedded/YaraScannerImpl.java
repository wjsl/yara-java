...
public class YaraScannerImpl implements YaraScanner {
     ...
     */
    @Override
    public void scan(File buffer, Map<String, String> moduleArgs) {
     ...
     */
    @Override
    public void scan(File buffer, Map<String, String> moduleArgs, YaraScanCallback yaraScanCallback) {
        ...
        try {
            ...
            int ret = library.rulesScanFile(peer, buffer.getAbsolutePath(), 0, callBackAddress, 0, timeout);
